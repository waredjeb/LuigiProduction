...
OUTDIR="/data_CMS/cms/portales/HHresonant_SKIMS/SKIMS_Radion_2018_metTrg_tauTrg_taumetsplit_dr04_05Jul2021/trigEff_output/"
...
for proc in $PROC
do
	python submit_triggerEff.py --indir=$INDIR --outdir=$OUTDIR --proc=$proc
done
