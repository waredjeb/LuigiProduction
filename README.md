...
- the configuration is accessible from within a single file (```tools/pid/luigi.cfg```)
...
```shell
LUIGI_CONFIG_PATH=tools/pid/luigi.cfg; python tools/pid/run_workflow.py --user <lxplus username> --scheduler <local|central> --force <#> --workers <#> --tag <some_tag>
```
